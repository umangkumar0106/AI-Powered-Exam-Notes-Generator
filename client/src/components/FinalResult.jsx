  ...
  return (
    <div className="mt-6 p-3 space-y-10 bg-white">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <h2
          className="text-3xl font-bold bg-linear-to-r from-indigo-600
      ...
      {quickRevision && (
        <section
          className="rounded-xl bg-linear-to-r
            from-green-100 to-green-50 border
      ...
      {result.charts && result.charts.length > 0 && (
        <section>
          ...
          <p className="mt-3 text-xs text-gray-500 italic">
            ℹ️ Charts help visualize important concepts for better understanding.
          </p>
        </section>
      )}
