      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        >
          ...
          <p className="text-sm text-gray-300 max-w-sm">
            ...
            material, daigrams, and printable PDFs using AI.
          </p>
        </Motion.div>

        <div className="text-center">
          <h1 className="text-sm font-semibold text-white mb">Quick Links</h1>
        ...
        <div className="text-center">
          <h1 className="text-sm font-semibold text-white mb">
            Support & Account
          </h1>
          <ul className="space-y-2 text-sm">
            <li
