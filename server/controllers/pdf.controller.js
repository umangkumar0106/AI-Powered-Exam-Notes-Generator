...
export const pdfDownload = async (req, res) => {
  ...
  Object.entries(result.subTopics).forEach(([star, topics]) => {
    doc.moveDown(0.5);
    const starText = star === "⭐" ? "Very Important" : star === "⭐⭐" ? "Important" : "Frequently Asked";
    doc.fontSize(13).text(`${starText} Topics:`);
